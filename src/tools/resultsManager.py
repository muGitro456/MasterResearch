...
def RNI(dFName1, dFName2) -> tuple:
    ...
    #print(n1_p)
    #print(n2_p)
    rni = (n1_p / (n1_p + n2_p), n2_p / (n1_p + n2_p))
    return rni

if __name__ == "__main__":
    args = sys.argv # コマンドライン引数
    #dFName1 = 'backLog/MASTER/Alpine/20230418/front_20230418_005947_080.csv'
    #dFName2 = 'backLog/MASTER/Alpine/20230412/front_20230412_182911_076.csv'
    
    p = input("aaa:")
    if len(args) == 3:
        dFName1 = args[1]
        dFName2 = args[2]
        print("【{}】と\n【{}】のRNIは...\n".format(dFName1, dFName2))
        rni = RNI(dFName1, dFName2)
        print("RNI = ", rni)
        if rni[0] > rni[1]:
            print("前者の方がイイ!")
        elif rni[0] < rni[1]:
        ...
        print("フォルダ名:【{}】内のパレートフロントを評価".format(args[1]))
        evaluation(args[1])
    else:
        print("引数が足りません.")